...
bitset <n> BCH_code_long_t3::decode_bch(const bitset <n> &Received_Codeword) {
	/*
...
void BCH_code_long_t3::print_message_and_decoded_message(const bitset <n> &Data, const bitset <n> &Decoded_Data) {
