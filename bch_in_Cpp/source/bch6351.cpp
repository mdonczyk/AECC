...
bitset <n> BCH_code_long_t2::decode_bch(const bitset <n> &Received_Codeword) {
	/*
...
void BCH_code_long_t2::print_message_and_decoded_message(const bitset <n> &Data, const bitset <n> &Decoded_Data) {
