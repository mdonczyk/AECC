...
vector <bool> BCH_code_short_t3::bytes_to_bits (const char *buffer, const int fileSize) {
...
int main(int argc, char* argv[]) {
    ...
    remove("image_with_errors_BCH_code_short_t3.bmp");
	remove("image_fixed_BCH_code_short_t3.bmp");
    file2.open ("image_with_errors_BCH_code_short_t3.bmp", ios::out | ios::app | ios::binary);
    file3.open ("image_fixed_BCH_code_short_t3.bmp", ios::out | ios::app | ios::binary);
	...
	cout << "Use \"feh -F -Z --force-aliasing -d " <<  argv[1] << " image_with_errors_BCH_code_short_t3.bmp image_fixed_BCH_code_short_t3.bmp\" to view made images on linux" << endl;
