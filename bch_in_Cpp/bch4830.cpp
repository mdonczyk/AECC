...
bitset <n> BCH_code_short_t3::introduce_errors(const bitset <n> &Codeword, const int &Probability) {
...
vector <bool> BCH_code_short_t3::bytes_to_bits (const vector <unsigned char> &Buffer) {
