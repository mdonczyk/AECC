...
vector <int> BCH_code_short_t3::calculate_syndromes(bool &Syn_error) {
...
int main(int argc, char* argv[]) {
    ...
    ofstream image_with_errors ("images/image_with_errors_BCH_code_short_t3.bmp", ios::out | ios::app | ios::binary);
    ofstream image_fixed ("images/image_fixed_BCH_code_short_t3.bmp", ios::out | ios::app | ios::binary);
	...
	vector <BCH_code_short_t3> BCH_objects;
	// start the clock:
	...
	cout << endl << "To view made images on linux use \"feh -F -Z --force-aliasing -d " << argv[2] << " images/image_with_errors_BCH_code_short_t3.bmp images/image_fixed_BCH_code_short_t3.bmp\"" << endl << endl;
