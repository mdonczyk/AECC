...
int main(int argc, const char* argv[]) {
	...
	string image_with_errors_path = string(argv[2]).append("_with_errors_BCH_code_short_t3.bmp");
	string image_fixed_path = string(argv[2]).append("_fixed_BCH_code_short_t3.bmp");
