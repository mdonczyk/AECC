...
vector <int> BCH_code_short_t2::calculate_syndromes(bool &Syn_error) {
...
void BCH_code_short_t2::print_original_codeword_and_received_codeword(const bitset <n> &Codeword, const bitset <n> &Received_Codeword) {
	if (verbose) {
...
void BCH_code_short_t2::print_original_message_and_decoded_message(const bitset <n> &Data, const bitset <k> &Decoded_Data) {
	if (verbose) {
...
bitset <n> BCH_code_short_t2::introduce_errors(const bitset <n> &Codeword, const int error_probability) {
...
int main(int argc, char* argv[]) {
    ...
    ofstream image_with_errors ("images/image_with_errors_BCH_code_short_t2.bmp", ios::out | ios::app | ios::binary);
    ofstream image_fixed ("images/image_fixed_BCH_code_short_t2.bmp", ios::out | ios::app | ios::binary);
	...
	vector <BCH_code_short_t2> BCH_objects;
	// start the clock:
	...
	cout << endl << "To view made images on linux use \"feh -F -Z --force-aliasing -d " << argv[2] << " images/image_with_errors_BCH_code_short_t2.bmp images/image_fixed_BCH_code_short_t2.bmp\"" << endl << endl;
